-- Phase 2B.4: automatically insert a durable award snapshot when spin_once generates a winning reward.
-- This is additive: spin_events and deliveries remain unchanged, but awards are created atomically.
