-- Migration 0015: Allow reactivating and extending ended campaigns
...
begin
  ...
  if p_status = 'active' then
    ...
    if v_current_status not in ('active', 'ended') then
      raise exception using errcode = '22023', message = 'only active or ended campaign can be paused';
    end if;
