-- Migration 0016: Support 'guest' scope in spin_once rule evaluation
...
begin
  ...
  for v_rule in
    ...
    where r.active
      ...
      and (
        r.scope = 'default'
        or (r.scope = 'guest' and (v_is_guest or coalesce(v_customer.registration_source, '') in ('zalo_guest', 'unlisted')))
        or exists (
